...
data = pd.read_csv("/content/IncidentReports.csv", encoding='latin1', sep=',', skiprows=[0], on_bad_lines='skip', engine='python')
data.columns
...
deaths_data = data[data["(Primary) Victim Severity"] == "Death"]
deaths_by_sex = deaths_data["(Primary) Victim's Sex"].value_counts().reset_index()
deaths_by_sex.columns = ['Sex', 'Count']

plt.figure(figsize=(8, 6))
sns.barplot(x='Sex', y='Count', data=deaths_by_sex, palette='viridis')
